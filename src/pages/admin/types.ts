...
export interface CMSRoomType {
  ...
  totalRooms?: number;    // total inventory count for this room type
...
export interface CMSDayPackage {
  ...
  image?: string;
  packages?: CMSDayPackageOption[];
}

export interface CMSDayPackageOption {
  id: string;
  title: string;
  description?: string;
  timing?: string;
