...
router.post('/hosts', ctrl.createHost);
router.patch('/hosts/:hostId/status', ctrl.updateHostStatus);
router.patch('/hosts/:hostId', ctrl.updateHostProfile);
router.patch('/hosts/:hostId/account', ctrl.updateHostAccount);
router.delete('/hosts/:hostId', ctrl.deleteHostAccount);
